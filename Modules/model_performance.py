...
def main():
    ...
    """
    metrics = get_metrics(
        model_path = r"/home/sam/Repositories/temp/artifact_project/models/dca_realistic/InceptionResNetV2/SGD/64/InceptionResNetV2_batchSize_0_opt_SGD_model.30.h5",
        src_path_val = r"/home/sam/Repositories/temp/artifact_project/images/balanced_dca_split/data/test/telea/oth/"
    )
